...
<p>Hobbies:</p>
			...
			<br/></br>
				<p>Favorite Websites:</p>	
					...
					<a href="http://nba.com"><img class="nba" alt="NBA Icon" src="<?php echo base_url('/image/nba.jpg'); ?>"/> </a>
					...
					<a href="http://9gag.com"><img class="gag" alt="9gag Icon" src="<?php echo base_url('/images/9gag.png'); ?>"/> </a>
					<a href="http://moodle2.apc.edu.ph"><img class="moodle" alt="Moodle Icon" src="<?php echo base_url('/image/moodle.png'); ?>"/> </a>
					<a href="http://mangafox.com"><img class="mangafox" alt="Mange Icon" src="<?php echo base_url('/image/mangafox.png'); ?>/>" </a>
